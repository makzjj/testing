"""Narrow ingress adapter for ProductionTestController workflow packets."""
...
class ProductionTestTransportAdapter(QObject):
    """Forward only Production-test-relevant packets to the test controller."""
